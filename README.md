# Book-Recommendation-using-Pyspark
Recommendation of books using Pyspark(collaboration of Apache Spark and Python).
...
you need to install Hadoop and Hbase also.
